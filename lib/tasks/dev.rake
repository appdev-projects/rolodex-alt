namespace(:dev) do
  ...
  task({ :prime => :environment }) do
    ...
    if ActiveRecord::Base.connection.table_exists? "restaurants"
      ...
      puts "You need to create a Resaurant table and model first! "\
        "Make sure you create a migration file. "\
        "Have you run rails db:migrate?"
     end
    ...
    if ActiveRecord::Base.connection.table_exists? "dishes"
      ...
      puts ""
      puts "You need to create a Dish table and model first!. "\
        "Make sure you create a migration file. "\
        "Have you run rails db:migrate?"
    end 
  end
